                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input id="title" type="text" name="title" placeholder="Pro Gamer"
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div class="flex items-center">
                <button form="delete-form"
                    class="rounded-md bg-red-600 px-3 py-2 text-sm font-bold text-white shadow-xs">Delete</button>
            </div>
            <div class="flex items-center gap-x-6">
                <a href="/jobs/{{ $job->id }}" type="button" class="text-sm font-semibold text-gray-900">Cancel</a>
                <div>
                    <button type="submit"
